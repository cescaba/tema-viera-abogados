...
function tema_viera_register_equipo_settings() {
	...
	register_setting( 'tema_viera_opciones_equipo', 'tema_viera_abogados_detalle_contenido_mobile' );
...
function tema_viera_opciones_equipo_page() {
	...
	$detalle_contenido_mobile = get_option( 'tema_viera_abogados_detalle_contenido_mobile', '' );
	...
	<div class="wrap">
		...
		<form method="post" id="mi-tema-opciones-equipo-form">
			...
			<div class="mi-tema-form-section">
				...
				<div class="mi-tema-form-group">
					<label for="detalle_contenido_mobile"><?php esc_html_e( 'Contenido en móvil (texto más corto)', 'tema-viera-abogados' ); ?></label>
					<textarea id="detalle_contenido_mobile" name="detalle_contenido_mobile" style="min-height:120px;"><?php echo esc_textarea( $detalle_contenido_mobile ); ?></textarea>
				</div>
...
function tema_viera_procesar_opciones_equipo() {
	...
	if ( isset( $_POST['detalle_contenido_mobile'] ) ) {
		update_option( 'tema_viera_abogados_detalle_contenido_mobile', wp_kses_post( $_POST['detalle_contenido_mobile'] ) );
	}
